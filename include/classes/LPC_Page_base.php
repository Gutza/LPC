...
class LPC_Page_base extends LPC_HTML_document
{
	...
	public function __construct()
	{
		...
		$this->content['head']->a(new LPC_HTML_link('icon','image/vnd.microsoft.icon', LPC_project_url."/favicon.ico"), "icon");
		$this->content['head']->a(new LPC_HTML_meta(array('http-equiv'=>'Content-type'), 'text/html;charset=UTF-8'), "content-type");
	}
